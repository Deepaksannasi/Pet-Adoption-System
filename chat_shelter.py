...
.navbar {{ background-color:#007bff; padding:0.8rem 1rem; }}
...
<li><a href="adopt_track.py?shelter_id={shelter_id}" class="nav-link active"><i class="bi bi-clipboard-check"></i> Adoption Tracking</a></li>
...
<h3 class='text-center text-primary'>Shelter-User Chat</h3>
<div class='chat-box'>
""")
